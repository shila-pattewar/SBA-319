...
// Create an index for the userId field (if you query by userId often)
storeSchema.index({ userId: 1 });  // Ascending index on userId

// Create an index for email field (if you query by email often)
storeSchema.index({ email: 1 }); // Ascending index on email
